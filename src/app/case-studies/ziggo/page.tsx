              ...
              <div className="max lg:col-span-2">
                <div>
                  ...
                  <p className="font-inter-tight text-muted-foreground mx-auto mb-8 max-w-2xl text-lg md:text-xl">
                    How Cerebello helped Ziggo, one of the Netherlands' largest
                    telecom providers, transform customer service and operations
                    with AI automation, achieving dramatic improvements in
                ...
                <div className="prose dark:prose-invert mb-8 max-w-full lg:max-w-prose">
                  ...
                  <p className="text-lg leading-6">
                    ...
                    processing, and internal reporting. Manual document handling
                    and disconnected data systems resulted in delays and
                  ...
                  <p className="text-lg leading-6">
                    Cerebello deployed an integrated AI-powered automation suite
                    tailored to Ziggo's specific operational needs. The
                    comprehensive solution addressed multiple pain points across
                    the organization:
                  </p>
                    ...
                    <table>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            NLP-based classification, intelligent routing, issue
                            categorization
                          </td>
                        </tr>
                  ...
                  <p className="text-lg leading-6">
                    Cerebello executed a phased rollout strategy, beginning with
                    discovery sessions with Ziggo's IT and operations
                  ...
                  <blockquote className="text-lg leading-7 font-semibold tracking-tight text-balance md:text-xl lg:text-2xl">
                    "Cerebello's modular AI solutions transformed our operations
                    without disrupting our existing systems. The results speak
                    for themselves—faster service, happier customers, and more
                    efficient teams."
                  </blockquote>
                  ...
                  <ul>
                    <li>
                      ...
                      customer inquiries through intelligent triage and routing
                    </li>
                    <li>
