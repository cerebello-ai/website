          ...
          <div className="relative flex-col gap-10 lg:flex lg:flex-row lg:justify-between">
              ...
              <div className="max lg:col-span-2">
                <div>
                  ...
                  <p className="font-inter-tight text-muted-foreground mx-auto mb-8 max-w-2xl text-lg md:text-xl">
                    ...
                    communications with a secure, AI-powered email platform that
                    reduced workload by 50% while maintaining complete data
                    privacy.
                  </p>
                ...
                <div className="prose dark:prose-invert mb-8 max-w-full lg:max-w-prose">
                  ...
                  <p className="text-lg leading-6">
                    ...
                    faced major communication and operational inefficiencies due
                    to email overload across departments. With sensitive
                    internal data preventing the use of cloud-based AI
                    solutions, the company needed a secure, on-premise solution
                    that could handle the complexity of their operations.
                  </p>
                  <p className="text-lg leading-6">
                    Customer Support, Legal, R&D, and Marketing teams all needed
                    better tools to handle repetitive email tasks, extract
                    insights, and speed up decision-making—while keeping all
                    data securely within Samsung's infrastructure.
                  </p>
                  ...
                  <Alert className="my-6">
                    ...
                    <AlertDescription>
                      All AI models were trained on Samsung's internal data and
                      kept fully on-premise, ensuring complete data privacy and
                    ...
                    <table>
                      ...
                      <tbody>
                        ...
                        <tr className="even:bg-muted m-0 border-t p-0">
                          <td>R&D</td>
                          <td>
                            Thread summarization, action item extraction, issue
                            clustering
                          </td>
                        </tr>
                        <tr className="even:bg-muted m-0 border-t p-0">
                  ...
                  <p className="text-lg leading-6">
                    ...
                    built the AI-enhanced mail client using an agile, iterative
                    approach:
                  </p>
                  <ul>
                  ...
                  <blockquote className="text-lg leading-7 font-semibold tracking-tight text-balance md:text-xl lg:text-2xl">
                    "Cerebello's solution transformed how our teams handle email
                    communications. The AI understands our context and helps us
                  ...
                  <p className="text-lg leading-6">
                    The implementation delivered significant improvements across
                    all departments:
                  </p>
                  <ul>
                    <li>
                      <strong>50% reduction</strong> in time spent on repetitive
                      email tasks
                    </li>
                    <li>
                      <strong>Faster response times</strong> to critical issues
                      and customer inquiries
                    </li>
                    <li>
                      <strong>Improved employee satisfaction</strong> through AI
                      support, not replacement
                    </li>
                    <li>
                      <strong>Complete data security</strong> with all sensitive
                      communications staying within Samsung's infrastructure
                    </li>
                  </ul>
            ...
            <div className="h-fit lg:sticky lg:top-8 lg:max-w-80">
              ...
              <p className="text-muted-foreground mb-6 text-sm">
                Samsung partnered with Cerebello to develop a custom on-premise
                AI email platform that transformed internal communications while
                maintaining complete data security and privacy.
              </p>
