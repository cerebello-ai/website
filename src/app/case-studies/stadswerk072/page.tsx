                ...
                <div className="max lg:col-span-2">
                  <div>
                    ...
                    <p className="font-inter-tight text-muted-foreground mx-auto mb-8 max-w-2xl text-lg md:text-xl">
                      ...
                      service organization, revolutionize citizen services
                      through AI-driven automation, improving responsiveness
                  ...
                  <div className="prose dark:prose-invert mb-8 max-w-full lg:max-w-prose">
                    ...
                    <p className="text-lg leading-6">
                      ...
                      rising workloads and limited resources, creating a
                    ...
                    <p className="text-lg leading-6">
                      ...
                      responsiveness and better serve residents without
                    ...
                    <Alert className="my-6">
                      ...
                      <AlertDescription>
                        All solutions were designed to be intuitive for
                        residents and easy for non-technical staff to manage,
                        with governance tools for oversight.
                      </AlertDescription>
                    </Alert>
                    ...
                    <p className="text-lg leading-6">
                      Cerebello partnered with Stadswerk072 to implement
                      AI-driven automation across key workflows, creating a
                      comprehensive smart city solution that transformed how the
                      municipality serves its citizens:
                    </p>
                      ...
                      <table>
                        ...
                        <tbody>
                          ...
                          <tr className="even:bg-muted m-0 border-t p-0">
                            ...
                            <td>
                              Work order generation, field team assignment,
                              issue tracking
                            </td>
                          </tr>
                          <tr className="even:bg-muted m-0 border-t p-0">
                    ...
                    <ul>
                      ...
                      <li>
                        Full rollout covering public repairs and permit
                        processing
                      </li>
                      <li>
                        Continuous refinement based on citizen and staff
                        feedback
                      </li>
                    </ul>
                    ...
                    <ul>
                      <li>
                        <strong>Waste pickup inquiries</strong> → Waste
                      ...
                      <li>
                        <strong>Noise complaints</strong> → Environmental
                        Services
                      </li>
                      <li>
                        <strong>Permit applications</strong> → Planning
                        Department
                      </li>
                    </ul>

                    <blockquote className="text-lg leading-7 font-semibold tracking-tight text-balance md:text-xl lg:text-2xl">
                      "Cerebello's AI solutions have transformed how we serve
                      our citizens. We can now respond faster, work smarter, and
                      focus our human resources where they matter most— on
                    ...
                    <p className="text-lg leading-6">
                      The implementation delivered remarkable improvements in
                      both operational efficiency and citizen satisfaction:
                    </p>
                    <ul>
                      <li>
                      ...
                      <li>
                        <strong>Resident satisfaction scores improved</strong>{' '}
                        due to faster response and issue resolution
                      </li>
                      <li>
                        <strong>
                    ...
                    <p className="text-lg leading-6">
                      This project demonstrates Cerebello's ability to help
                      local governments scale their citizen services through
                      smart automation—enhancing both operational efficiency and
                      the public experience while keeping costs predictable and
                      data handling compliant. By focusing on practical,
