...
const testimonials = [
  {
    ...
    quote: 'Cerebello integrated our citizen-facing portal with back-end permitting systems, eliminating redundant data entry across departments. Permit approval times decreased significantly while improving transparency for citizens.',
  ...
  },
  {
    ...
    quote: 'Our e-commerce platform now seamlessly connects to warehouse management, ERP, and delivery tracking systems. Orders move from purchase to delivery without manual hand-offs, eliminating delays and errors.',
    author: 'Marcus Chen',
  ...
  },
  {
    ...
    quote: 'We integrated our EHR system with patient mobile apps, lab systems, and IoT medical devices. Providers now have a 360° view of patient information in real time while maintaining strict HIPAA compliance.',
...
const apiIntegrationMethodologySteps = [
  {
    ...
    description: 'We conduct an in-depth assessment of your current systems, data flows, and pain points. Our team identifies integration opportunities that align with your business goals and automation vision.',
  },
  {
    step: '02',
    title: 'Architecture & Design',
    subtitle: 'Integration Blueprint',
    description: 'Our architects design tailored integration solutions choosing the right approach for each use case. We define data models, API specifications, error handling, and security measures.',
  },
  {
    step: '03',
    title: 'Development & Orchestration',
    subtitle: 'API Implementation',
    description: 'We develop custom APIs, configure integration platforms, and build the connections between systems. Our agile approach ensures incremental progress with regular reviews.',
  },
  {
    step: '04',
    title: 'Testing & Validation',
    subtitle: 'Quality Assurance',
    description: 'Rigorous testing includes unit testing of APIs, integration testing, performance testing, and security validation. We ensure reliability, accuracy, and security under all conditions.',
  },
  {
    step: '05',
    title: 'Deployment & Training',
    subtitle: 'Go-Live Support',
    description: 'We handle production deployment with minimal downtime and provide training to your team. Clear documentation ensures your organization can own and maintain the solution.',
  },
  {
    step: '06',
    title: 'Ongoing Support & Optimization',
    subtitle: 'Continuous Improvement',
    description: 'Post-deployment support includes monitoring, performance tuning, and iterative enhancements. We help your integration ecosystem continuously evolve with your business.',
  },
];
...
const apiIntegrationBenefits = [
  {
    ...
    description: 'Seamlessly integrate internal applications and external platforms with robust RESTful APIs and modern integration patterns',
  },
  {
    title: 'Legacy System Integration',
    description: 'Unlock the value in existing systems by connecting legacy platforms with modern applications through API wrappers',
  },
  {
    title: 'Real-Time & Batch Data Synchronization',
    description: 'Support both instant updates and scheduled data transfers with consistent data integrity across all systems',
  },
  {
    title: 'Secure API Governance',
    description: 'Implement robust security, traffic management, version control, and monitoring with industry-standard governance frameworks',
  },
];
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="font-inter space-y-6 text-lg leading-relaxed">
              <p>
                Cerebello's API Integration services connect and orchestrate your enterprise systems through robust, secure APIs. By leveraging application programming interfaces to integrate software applications, platforms, and workflows, we enable seamless exchange of data and services across your organization. This breaks down data silos and creates unified ecosystems where information flows effortlessly.
              </p>

              <p>
                When systems communicate in real time, you can automate intelligent workflows that were previously manual and disconnected. Our integrations connect independent applications to create automated business processes, enabling real-time data flow between databases and enterprise applications. The result is reduced manual effort, faster processes, better system interoperability, and a scalable architecture that grows with your needs.
              </p>

              <p>
                Whether connecting custom legacy systems or third-party platforms like ERP, CRM, SaaS applications, and IoT devices, we transform fragmented processes into intelligent workflows. Our integration-first approach ensures analytics solutions that enhance, not uproot, your current operations while protecting your IT investments and accelerating time-to-value.
              </p>

              <div className="bg-sand-50 mt-8 rounded-lg p-6">
                <p className="font-inter-tight text-sand-900 text-xl font-medium">
                  Ready to connect your systems and automate your workflows? Discover how API integration can transform your operations.
                </p>
                <Button
                  variant="outline"
                  size="lg"
