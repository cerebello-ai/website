...
export const metadata: Metadata = {
  title:
    'Change Management for AI & Automation | Adoption Strategy | Cerebello',
  description:
...
const testimonials = [
  {
    ...
    quote:
      'Cerebello led comprehensive change enablement for our AI-powered email platform across multiple departments. Over 90% of staff reported satisfaction with the AI assistant, transforming how teams handle email while maintaining security.',
    author: 'Kim Sung-ho',
  ...
  },
  {
    ...
    quote:
      'Change management was critical for our predictive maintenance rollout. Cerebello helped us achieve 200% ROI in the first year by ensuring our technicians fully embraced and utilized the AI-powered monitoring systems.',
...
const changeManagementMethodologySteps = [
  {
    ...
    description:
      'Evaluate organizational preparedness through surveys, interviews, and workshops. Map key stakeholders and build coalition for change with early involvement of leadership and influential team members.',
  },
  {
    step: '02',
    ...
    description:
      'Develop customized change management plan with compelling vision, clear case for change, and defined roles. Craft communication strategy focusing on how AI assists rather than replaces employees.',
  },
  {
    step: '03',
    ...
    description:
      'Maintain transparent communication through town halls, updates, and interactive Q&A sessions. Address fears head-on and highlight quick wins to build understanding and enthusiasm.',
  },
  {
    step: '04',
    ...
    description:
      'Design role-specific training programs with hands-on workshops, e-learning modules, and coaching. Transform anxiety into empowerment by building confidence with new AI tools.',
  },
  {
    step: '05',
    ...
    description:
      'Start with pilot groups to gather feedback and refine approach. Publicize early successes to create positive momentum and peer encouragement throughout the organization.',
  },
  {
    step: '06',
    ...
    description:
      'Provide real-time support during launch and monitor adoption metrics. Maintain feedback channels and conduct follow-up training to ensure lasting cultural transformation.',
  },
];
...
const changeManagementBenefits = [
  {
    ...
    description:
      'Build strong coalition for change with clear vision, defined roles, and consistent leadership communication throughout organization',
  },
  {
    title: 'Comprehensive Training & Skill Development',
    description:
      'Role-specific programs with hands-on workshops, e-learning, and coaching to build confidence and competency with AI tools',
  },
  {
    title: 'Trust Building & Resistance Management',
    description:
      'Address fears proactively through transparent communication, focusing on AI augmentation rather than job replacement',
  },
  {
    title: 'Adoption Monitoring & Continuous Support',
    description:
      'Data-driven monitoring of usage metrics with ongoing support and feedback loops to ensure sustained transformation',
  },
];
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="font-inter space-y-6 text-lg leading-relaxed">
              <p>
                Introducing cutting-edge AI or automation is only half the
                battle – the other half is ensuring your people embrace the
                change. Cerebello's Change Management service focuses on the
                human side of digital transformation, guiding medium to large
                organizations through the cultural and organizational shifts
                that come with AI adoption.
              </p>

              <p>
                Studies show that fear of job loss, lack of trust in AI, and
                general resistance to change are common barriers to AI adoption.
                These human factors cause up to 70% of change programs to fail,
                rather than the technology itself. We help business and
                technology leaders prepare their teams, align stakeholders, and
                build trust so that new AI and intelligent systems are not just
                deployed, but fully adopted and utilized.
              </p>

              <p>
                By prioritizing communication, training, and empathy, we turn
                potential resistance into enthusiasm, ensuring your AI
                initiatives deliver lasting value. Our structured, human-centric
                approach addresses employee fears, builds capabilities, and
                creates cultural alignment that drives successful transformation
                with measurable outcomes.
              </p>

              <div className="bg-sand-50 mt-8 rounded-lg p-6">
                <p className="font-inter-tight text-sand-900 text-xl font-medium">
                  Ready to ensure successful AI adoption? Discover how strategic
                  change management can drive lasting transformation.
                </p>
                <Button
                  variant="outline"
                  size="lg"
