        ...
        <div className="grid items-center gap-8 lg:grid-cols-2">
          ...
          <div className="bg-accent grid aspect-3/4 grid-cols-[1fr_10fr_1fr] grid-rows-[2fr_10fr_2fr]">
            ...
            <div className="relative">
              <div className="border-border bg-background absolute top-[8%] left-[12%] flex aspect-3/4 w-[60%] justify-center rounded-lg border"></div>
            ...
            <div className="border-border relative border-t border-r">
              <div className="bg-accent-foreground ring-accent absolute -top-[6px] -right-[6px] size-[12px] rounded-full border-[3px] border-[hsl(var(--color-accent-foreground))] ring-[8px]"></div>
            </div>
