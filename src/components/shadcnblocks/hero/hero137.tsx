const Hero137 = () => {
  return (
    <section className="relative flex flex-col gap-20 bg-muted-2 px-10 py-16 font-sans lg:h-svh lg:flex-row lg:items-end lg:justify-start lg:pr-0 lg:pl-20">
      <div className="relative z-10 flex max-w-[51rem] flex-col gap-10">
        <h1 className="text-5xl font-medium text-foreground md:text-7xl lg:text-8xl lg:font-normal">
          The all-in-one writing space
        </h1>
        <p className="max-w-[27.5rem] text-lg text-muted-foreground">
