import { Headphones, Settings, Timer } from "lucide-react";
...
const Hero113 = () => {
  return (
    <section className="font-outfit bg-background py-12 md:py-20">
      <div className="container max-w-4xl xl:max-w-7xl">
        <div className="flex flex-col items-center gap-6">
          <div className="max-w-3xl">
            <h1 className="mb-3 text-center text-4xl leading-tight font-medium text-foreground sm:text-5xl md:text-6xl xl:text-7xl">
              Take{" "}
              <span className="relative inline-block">
                <span className="relative z-20">control</span>
                <svg
                  className="pointer-events-none absolute top-[54%] left-1/2 z-10 w-[100%] -translate-x-1/2 -translate-y-1/2 transform fill-orange-400"
                  viewBox="0 0 191 75"
                  fill="none"
              ...
              of your team roadmap.
            </h1>
            <p className="text-center text-xl text-muted-foreground">
              Easily plan and publish your products feature roadmap.
            </p>
          </div>
          <div className="flex flex-col items-center justify-center gap-4 md:flex-row">
            <Button
              asChild
              className="shadow-[0_3px_3px_0_theme(colors.muted2.DEFAULT)] h-fit w-fit rounded-full px-5 py-4 text-base leading-relaxed font-medium"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="h-fit w-fit rounded-full px-5 py-4 text-base leading-relaxed font-medium"
            >
        ...
        <div className="mt-9 mb-16 h-auto w-full max-w-7xl overflow-hidden rounded-2xl border-[5px] border-black bg-muted shadow-xl sm:mt-11 sm:mb-20 md:mt-14 md:mb-24 lg:mt-20 lg:mb-32">
        ...
        <div className="flex w-full flex-wrap justify-center gap-16">
          <div className="flex max-w-[380px] min-w-[300px] flex-1 flex-col gap-5 xl:flex-row xl:items-center">
            <div className="flex h-16 w-16 shrink-0 rounded-full bg-muted">
              <Settings className="m-auto h-6 w-6 stroke-muted-foreground" />
            </div>
            <p className="text-lg leading-relaxed font-medium text-foreground">
              The fastest, easiest way to launch a stunning website.
            </p>
          </div>
          <div className="flex max-w-[380px] min-w-[300px] flex-1 flex-col gap-5 xl:flex-row xl:items-center">
            <div className="flex h-16 w-16 shrink-0 rounded-full bg-muted">
              <Timer className="m-auto h-6 w-6 stroke-muted-foreground" />
            </div>
            <p className="text-lg leading-relaxed font-medium text-foreground">
              We make launching an attractive website fast and easy.
            </p>
          </div>
          <div className="flex max-w-[380px] min-w-[300px] flex-1 flex-col gap-5 xl:flex-row xl:items-center">
            <div className="flex h-16 w-16 shrink-0 rounded-full bg-muted">
              <Headphones className="m-auto h-6 w-6 stroke-muted-foreground" />
            </div>
            <p className="text-lg leading-relaxed font-medium text-foreground">
              We make launching an attractive website fast and easy.
            </p>
