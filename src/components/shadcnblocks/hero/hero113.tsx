      ...
      <div className="container max-w-4xl xl:max-w-7xl">
        <div className="flex flex-col items-center gap-6">
          <div className="max-w-3xl">
            <h1 className="text-foreground mb-3 text-center text-4xl leading-tight font-medium sm:text-5xl md:text-6xl xl:text-7xl">
              Take{' '}
        ...
        <div className="bg-muted mt-9 mb-16 h-auto w-full max-w-7xl overflow-hidden rounded-2xl border-[5px] border-black shadow-xl sm:mt-11 sm:mb-20 md:mt-14 md:mb-24 lg:mt-20 lg:mb-32">
        ...
        <div className="flex w-full flex-wrap justify-center gap-16">
          <div className="flex max-w-[380px] min-w-[300px] flex-1 flex-col gap-5 xl:flex-row xl:items-center">
            <div className="bg-muted flex h-16 w-16 shrink-0 rounded-full">
              <Settings className="stroke-muted-foreground m-auto h-6 w-6" />
            </div>
          ...
          <div className="flex max-w-[380px] min-w-[300px] flex-1 flex-col gap-5 xl:flex-row xl:items-center">
            <div className="bg-muted flex h-16 w-16 shrink-0 rounded-full">
              <Timer className="stroke-muted-foreground m-auto h-6 w-6" />
            </div>
            <p className="text-foreground text-lg leading-relaxed font-medium">
          ...
          <div className="flex max-w-[380px] min-w-[300px] flex-1 flex-col gap-5 xl:flex-row xl:items-center">
            <div className="bg-muted flex h-16 w-16 shrink-0 rounded-full">
              <Headphones className="stroke-muted-foreground m-auto h-6 w-6" />
            </div>
            <p className="text-foreground text-lg leading-relaxed font-medium">
              We make launching an attractive website fast and easy.
            </p>
