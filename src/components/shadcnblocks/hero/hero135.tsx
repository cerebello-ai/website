              ...
              <div className="relative w-full overflow-hidden rounded-3xl">
                <AspectRatio ratio={1}>
                  <div className="size-full">
                    <video
                      src="https://deifkwefumgah.cloudfront.net/shadcnblocks/block/video-3.mp4"
                      muted
                      autoPlay
                      loop
                    ...
                    <Button
                      ...
                      className="bg-background hover:bg-background absolute bottom-0 left-0 m-10 flex size-fit w-fit items-center gap-4 rounded-full py-3 pr-8 pl-3 transition-transform hover:scale-105"
                    >
