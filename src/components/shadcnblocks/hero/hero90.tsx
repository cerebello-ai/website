        ...
        <div className="grid grid-cols-1 gap-10 md:gap-20 xl:grid-cols-2">
          ...
          <div>
            <div className="relative mx-auto aspect-[1.723502304/1] max-w-[46.75rem]">
              <div className="absolute top-0 left-0 z-30 flex aspect-square w-[42%] rounded-2xl bg-muted-2 sm:rounded-3xl md:rounded-[2.25rem]">
              ...
              <div className="absolute right-0 bottom-[15%] z-10 flex aspect-square w-[42%] rounded-2xl bg-muted-2 sm:rounded-3xl md:rounded-[2.25rem]">
                <div className="m-auto w-[85%]">
                  ...
                  <p className="line-clamp-4 text-[clamp(0.5rem,2.5vw,1.25rem)] font-semibold text-muted-2-foreground">
