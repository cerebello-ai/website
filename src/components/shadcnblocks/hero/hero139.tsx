...
const Hero139 = () => {
  return (
    <section className="dark relative isolate h-screen overflow-hidden bg-background px-6 pt-14 lg:px-8">
      ...
      <div className="absolute right-0 -bottom-1/2 left-0 -z-10 m-auto h-[820px] w-[1440px] animate-pulse rounded-full bg-muted/70 blur-[100px]"></div>
    </section>
  );
};
