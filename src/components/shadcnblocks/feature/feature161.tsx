    ...
    <section className="py-32">
      <div className="container">
        <div className="border-muted-foreground/25 relative grid grid-cols-1 grid-rows-2 border lg:grid-cols-2 lg:grid-rows-1">
          <div className="bg-muted-foreground/25 absolute top-[-16px] left-[-1px] h-4 w-[1px]" />
          <div className="bg-muted-foreground/25 absolute top-[-1px] left-[-16px] h-[1px] w-4" />
          ...
          <div className="grid grid-cols-1 grid-rows-7">
            ...
            <div className="border-muted-foreground/25 row-start-2 row-end-7 flex items-center justify-center gap-8 border-t border-b">
          ...
          <div className="bg-muted-foreground/25 absolute top-[-16px] right-[-1px] h-4 w-[1px]" />
          <div className="bg-muted-foreground/25 absolute top-[-1px] right-[-16px] h-[1px] w-4" />
          <div className="bg-muted-foreground/25 absolute right-[-1px] bottom-[-16px] h-4 w-[1px]" />
          <div className="bg-muted-foreground/25 absolute right-[-16px] bottom-[-1px] h-[1px] w-4" />
        </div>
      </div>
    </section>
  );
