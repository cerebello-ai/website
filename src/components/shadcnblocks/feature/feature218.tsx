        ...
        <div className="container flex w-full flex-col gap-6">
          ...
          <div className="grid w-full gap-4 xl:grid-cols-[.33fr_.66fr]">
            ...
            <div className="pt-10 xl:pt-20">
              <div className="after:to-background relative ml-auto w-full max-w-[50rem] after:absolute after:top-0 after:right-0 after:z-20 after:block after:h-full after:w-1/3 after:rounded-tr-2xl after:bg-linear-90 after:from-transparent after:content-['']">
                <AspectRatio
                  ratio={1.932}
