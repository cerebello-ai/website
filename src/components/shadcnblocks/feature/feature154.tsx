  ...
  return (
    <section className="before:bg-primary/10 relative py-32 before:absolute before:inset-0 before:[mask-image:url('https://deifkwefumgah.cloudfront.net/shadcnblocks/block/patterns/waves.svg')] before:[mask-repeat:repeat] before:[mask-size:64px_32px]">
      ...
      <div className="container mx-auto">
        <div className="z-3 relative flex flex-col items-center gap-8">
          <Badge
            variant="secondary"
        ...
        <div className="before:z-2 after:z-2 relative m-auto mt-20 w-[calc(100%-100px)] overflow-hidden before:absolute before:left-0 before:top-0 before:h-full before:w-28 before:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] before:content-[''] after:absolute after:right-0 after:top-0 after:h-full after:w-28 after:-scale-x-100 after:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] after:content-[''] max-[980px]:mt-12 max-[980px]:w-full max-[580px]:mt-9">
          <div className="animate-infinite-slider flex w-[calc(250px*10)]">
            {badges.map((item, index) => (
              <Badge
                ...
                key={index}
              >
                <p className="bg-accent flex size-8 max-h-10 min-h-10 min-w-10 max-w-10 items-center justify-center rounded-full lg:size-10">
                  {item.icon}
                </p>
        ...
        <div className="before:z-2 after:z-2 relative m-auto mt-11 w-[calc(100%-100px)] overflow-hidden before:absolute before:left-0 before:top-0 before:h-full before:w-28 before:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] before:content-[''] after:absolute after:right-0 after:top-0 after:h-full after:w-28 after:-scale-x-100 after:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] after:content-[''] max-[980px]:w-full">
