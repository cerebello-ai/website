        ...
        <Tabs defaultValue={DATA[0].title} className="">
          <TabsList className="h-auto w-full bg-transparent p-0 max-lg:flex-col max-lg:divide-y lg:grid lg:grid-cols-3 lg:divide-x">
            {DATA.map((item, index) => (
              ...
              >
                <div className="absolute bottom-[-1px] left-0 h-[1px] w-0 bg-linear-to-r from-blue-600 via-sky-300 to-transparent transition-all duration-300 group-data-[state=active]:w-1/2" />
                ...
                <div className="flex items-center gap-2 p-4">
                  <div className="relative size-6">
                    <div className="to-border absolute inset-0 -rotate-45 rounded-full bg-linear-to-l from-blue-600 via-sky-300 to-50% transition-all duration-1000 group-data-[state=inactive]:opacity-0" />
