        ...
        <div className="relative z-20 container">
          <div className="grid items-start justify-start gap-14 xl:grid-cols-[0.75fr_1fr] xl:items-center xl:justify-center">
            <div className="flex flex-col gap-4.5">
              <h2 className="text-[1.625rem] font-semibold text-white md:text-[2.5rem]">
                Designing Inclusive Experiences for All.
              </h2>
              <div className="text-lg font-medium text-white md:text-[1.375rem]">
            ...
            <div>
              <div className="w-[75%] max-w-[33.5rem] xl:mx-auto xl:w-full">
                <AspectRatio
                  ratio={0.80239521}
