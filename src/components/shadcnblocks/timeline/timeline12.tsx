...
const Timeline12 = ({
  title = 'Our Process',
  subtitle = 'Follow our proven methodology',
  phasesData = [
    {
      id: 'phase1',
      phase: '1',
    ...
    },
    {
      ...
      description:
        'The final phase focuses on deployment and maintenance. Ensure successful launch and ongoing support.The final phase focuses on deployment and maintenance. Ensure successful launch and ongoing support.',
      imageSrc:
        'https://deifkwefumgah.cloudfront.net/shadcnblocks/block/placeholder-4.svg',
      imageAlt: 'Phase 4 illustration',
    },
  ],
  defaultActivePhase = 'phase1',
        ...
        <Tabs defaultValue="phase1" className="w-full">
          <TabsList className="grid w-full grid-cols-4 bg-transparent p-0">
            {PHASES__DATA.map((phase) => (
              <TabsTrigger
                key={phase.id}
                className="text-md data-[state=active]:border-b-foreground rounded-none border-b-2 pb-6 shadow-none!"
                value={phase.id}
              >
