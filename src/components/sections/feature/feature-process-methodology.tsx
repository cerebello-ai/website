          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <div className="bg-sand-100 mb-4 flex h-12 w-12 items-center justify-center rounded-full">
                ...
                <p className="font-inter-tight text-sand-600 mb-3 text-sm font-medium">
                  {step.subtitle}
                </p>
